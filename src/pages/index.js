...
import { RawHtml, StackItem, Override, Stack } from "@quarkly/components";
export default (() => {
	return <Theme theme={theme}>
		...
		<Section
			padding="140px 0"
			sm-padding="40px 0"
			background="linear-gradient(0deg,rgba(0,0,0,.2) 0%,rgba(0,0,0,.2) 100%),--color-dark url(https://images.unsplash.com/photo-1608512532288-8f985c15345d?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&w=2000) 50% 15%/cover"
			color="--light"
			font="--base"
			sm-background="--color-dark url(https://images.unsplash.com/photo-1608512532288-8f985c15345d?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&w=2000) 50% 15%/cover"
			sm-position="static"
		...
		>
			...
			>
				<Image
					src="https://uploads.quarkly.io/60f12b580c45e4001752d5f4/images/Artboard%202@2x.png?v=2021-08-28T10:28:38.157Z"
					width="110px"
					position="relative"
					sm-width="70px"
					sm-height="70px"
			...
			<Stack text-align="justify" align-self="stretch">
				<StackItem
					width="25%"
					lg-width="50%"
					sm-width="100%"
				...
				<StackItem width="25%" lg-width="50%" sm-width="100%">
					<Text margin="0px">
						SuperIntelligence Amplification
					</Text>
				</StackItem>
				<StackItem
					width="25%"
					...
					sm-text-align="left"
				>
					<Override slot="StackItemContent" justify-content="flex-end" sm-text-align="left" sm-display="block" />
					<Text margin="0px" sm-text-align="left" sm-order="0" sm-align-self="flex-end">
						SuperIntelligent Robotics
					</Text>
				</StackItem>
			</Stack>
		</Section>
